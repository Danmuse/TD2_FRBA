...
//! @hideinitializer Defines a string literal that describes a message indicating that the flash memory was not found.
#define ERR_FLASH_NOT_FOUND "FLASH MEMORY\\nNOT FOUND"
//! @hideinitializer Defines a string literal that describes a message indicating that communication fails with the flash memory.
#define ERR_FLASH_READ_FAILURE "FAILURE TO READ\\nFLASH MEMORY"
//! @hideinitializer Defines a string literal that describes a message indicating that the current section was not implemented.
