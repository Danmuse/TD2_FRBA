...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  if(hdac->Instance==DAC)
  {
    ...
    PA5     ------> DAC_OUT2
    */
    GPIO_InitStruct.Pin = DAC_DDS_CLAMP_Pin|DAC_VCLAMP_Pin;
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC)
  {
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC_DDS_CLAMP_Pin|DAC_VCLAMP_Pin);
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  if(hqspi->Instance==QUADSPI)
  {
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    GPIO_InitStruct.Pin = DSCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_QSPI;
    HAL_GPIO_Init(DSCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DSPI_IO0_Pin|DSPI_IO1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_QSPI;
    ...
    HAL_GPIO_Init(CS_W25Q_GPIO_Port, &GPIO_InitStruct);
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  if(hqspi->Instance==QUADSPI)
  {
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    HAL_GPIO_DeInit(GPIOB, DSCK_Pin|CS_W25Q_Pin);

    HAL_GPIO_DeInit(GPIOC, DSPI_IO0_Pin|DSPI_IO1_Pin);
